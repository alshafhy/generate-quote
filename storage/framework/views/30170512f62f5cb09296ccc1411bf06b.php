<aside class="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <img src="<?php echo e(asset('images/company-logo.png')); ?>" alt="Logo">
        </div>
    ...
    <nav>
        ...
        <ul class="sidebar-menu">
            <li class="<?php echo e(request()->routeIs('analysis') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('analysis')); ?>"><i class="fas fa-th-large"></i> الاحصائيات</a>
            </li>
            <li class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('dashboard')); ?>"><i class="fas fa-user"></i> الملف الشخصي</a>
            </li>
            <li class="<?php echo e(request()->routeIs('employees.index') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('employees.index')); ?>"><i class="fas fa-users"></i> ادارة الموظفين</a>
            </li>
            <li><a href="#"><i class="fas fa-key"></i> ادارة الصلاحيات</a></li>
            <li><a href="#"><i class="fas fa-user-friends"></i> ادارة العملاء</a></li>
            <li class="<?php echo e(request()->routeIs('vehicles.index') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('vehicles.index')); ?>"><i class="fas fa-car"></i> ادارة المركبات</a>
            </li>
